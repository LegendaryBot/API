...
public class AWSGetOverwatchStats implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
    @Override
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        ...
        String battletag = pathParameters.get("battletag");
        MessageEmbed overwatchStats = OverwatchHelper.getOverwatchStats(region, battletag);
        if (overwatchStats == null) {
            ...
            return ApiGatewayResponse.builder()
                    .setStatusCode(200)
                    .setRawBody(overwatchStats.toJSONObject().toString())
                    .build();
        }
    }
}
